...
<center>
    <div class="wrapper" >
            ...
            <form action="adrouteC.php" method="get" style="width: 90%; margin-top: 10px;">
  ...
  <span class="step-order" style="text-align: left;">Choisir La Spécialité:</span>

      <select class="custom-select" id="inlineFormCustomSelectPref" name="specialite" style="width: 90%; border-radius: 5px; margin-top: 5px; position: absolute;
  left: 25px">
      <?php while ($row3 = mysqli_fetch_array($listcat)):?>
        <option style="width: 50%; border-radius: 25px;" value="<?php echo $row3[0]; ?>"><?php echo $row3[1]; ?></option>
      <?php endwhile; ?>
    </select>
<br>
<br>
<span class="step-order" style="text-align: left;">Choisir Le Niveau:</span>
    <select class="custom-select" id="inlineFormCustomSelectPref" name="niveau" style="width: 90%; border-radius: 5px; margin-top: 5px; position: absolute;
  left: 25px;">
...
<br>
  ...
  right: 30px; background-color: #8EB852; border-color: #8EB852;" type="submit" value="Confirmer" class="btn btn-success">
