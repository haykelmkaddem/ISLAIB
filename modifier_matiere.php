...
$mat="SELECT * FROM matiere ORDER BY id_mat DESC";
...
<h3>Modifier/Supprimer Des Matiére</h3>
</div>
 ...
 <table class="table table-striped" style="text-align: center;">
      <thead>
          <tr>
              <th style="width: 30%;">Coefficient</th>
      ...
      <tbody>
        <?php while ($row3 = mysqli_fetch_array($listmat)):?>
          <tr>
              ...
              <td>
                <a href="modifmatiere.php?id_mat=<?php echo $row3[0];?>">
                <img src="images/modif.png" style="width: 10%; height: 6%;"></a>
                <a href="#" data-toggle="modal" data-target="#exampleModal">
                <img src="images/sup.png" style="width: 10%; height: 6%;"></a>
              </td>
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Supprimer Matiére</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Voulez-vous vraiment supprimer cette Matiére  ?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <a href="supprimer_matiere.php?id_mat=<?php echo $row3[0];?>"> <button type="button" class="btn btn-danger">Supprimer</button></a>
                        </div>
                    </div>
                </div>
            </div>
