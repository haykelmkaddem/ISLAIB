...
?>
 ...
 <table class="table table-striped" style="text-align: center;">
      <tbody>
        <?php while ($row3 = mysqli_fetch_array($listclasse)):
          $r=$row3[0];
          $rel="SELECT * FROM relever where id_classe=$r";
          $listrel=mysqli_query($conn,$rel);
          if (mysqli_fetch_array($listrel)) {

          ?>
          <tr>
              <td style="width: 70%;"><?php echo $row3[1]; ?></td>
          ...
          <tr>
              <td style="width: 70%;"><?php echo $row3[1]; ?></td>
              <td>
                <form method="get" action="ajrelever.php">
<input type="text" name="id_classe" value="<?php echo $row3[0]; ?>" hidden>
