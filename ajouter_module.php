...
<center>
    <div class="wrapper" >
         <div class="container">
             ...
             <form action="ajmodule.php" method="get">
               <fieldset>
                 ...
                 <div class="form-group" style="color: black;">
                   ...
                   <input type="text" class="form-control" name="coefficient_mod" >
                 </div>


                 <div class="form-group" style="color: black;">
                   <label for="email">Entrez Le Nom Du Module <span style="color: red;">*</span></label>
                   <input type="text" class="form-control" name="nom_mod" >
                 </div>
               </fieldset>

               <input style="margin-top: 7px; border-radius: 5px; position: absolute;
  right: 30px; background-color: #8EB852; border-color: #8EB852;" type="submit" value="Ajouter" class="btn btn-success">
             </form>
         </div>
</div>
