...
<center>
    <div class="wrapper" >
            ...
            <form action="adrouteC1.php" method="get" style="width: 90%; margin-top: 10px;">
  ...
  <span class="step-order" style="text-align: left;">Choisir La Semestre:</span>

      <select class="custom-select" id="inlineFormCustomSelectPref" name="semestre" style="width: 90%; border-radius: 5px; margin-top: 5px; position: absolute;
  left: 25px">
      <?php while ($row3 = mysqli_fetch_array($listsem)):?>
