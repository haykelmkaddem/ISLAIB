...
$module="SELECT * FROM module where (id_sp =$sp and id_niv=$niv and id_sem=$sem)";
...
<center>
    <div class="wrapper" >
            ...
            <form action="adrouteC3.php" style="width: 90%; margin-top: 10px;">
  ...
  <span class="step-order" style="text-align: left;">Choisir La module:</span>

      <select class="custom-select" id="inlineFormCustomSelectPref" name="module" style="width: 90%; border-radius: 5px; margin-top: 5px; position: absolute;
  left: 25px">
      <?php while ($row3 = mysqli_fetch_array($listmodule)):?>
        <option style="width: 50%; border-radius: 25px;" value="<?php echo $row3[0]; ?>"><?php echo $row3[3]; ?></option>
      <?php endwhile; ?>
    </select>
<br>
<br>
