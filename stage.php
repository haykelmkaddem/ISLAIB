...
<center>
  <form action="ajnotestage.php" method="get">
<table width="65%" style="text-align: center;">
  ...
  <tr>
    ...
    <th style="border: 1px solid black;">Note Stage</th>
  </tr>
  ...
  $i=0;
    ...
    <td style="border: 1px solid black;">
      ...
      <input type="text" name="notestage<?php echo $i; ?>" style="color: black; width: 100%;"></td>
  </tr>
<?php
}
?>
