...
<center>
  <form action="ajmoyenne.php" method="get">
<table width="55%" style="text-align: center;">
  <tr>
    <th></th>
    <th style="border: 1px solid black;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;Groupe: <?php echo $row2[1]; ?> </th>
  </tr>
  <tr>
    <th style="border: 1px solid black; width: 150px;">CIN</th>
    <th width="25%" style="border: 1px solid black;">Nom et Prenom</th>
    <th style="border: 1px solid black; width: 40%;">Moyennes</th>
  </tr>
  ...
  $i=0;
    ...
    <td style="border: 1px solid black;">
      ...
      <input type="text" name="moyenne<?php echo $i; ?>" style="color: black; width: 100%;"></td>
  </tr>
<?php
}
?>
</table>
<input style="margin-top: 7px; border-radius: 20px; margin-right: -610px; background-color: #8eb852; border-color: #8eb852;" type="submit" value="Ajouer Les Notes" class="btn btn-success">
