...
$module="SELECT * FROM module  where (id_sp='$test1' and id_niv='$test2')";
...
?>
<center>
<table style="width: 70%; text-align: center; margin-top: 30px;" border="2">
  <tr>
...
?>
    <tr>
      ...
      <td><?php echo $note2[1]; ?></td>
      <td><?php echo $note2[2]; ?></td>
      <td><?php echo $note2[3]; ?></td>
...
<button class="btn btn-primary hidden-print" onclick="imprimer_page()" style="margin-top: 20px; margin-bottom: 50px; width: auto;"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
