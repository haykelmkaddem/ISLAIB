...
.buttonaccepted {
    ...
    font-size: 16px ;
            ...
            .btn-pret:hover{background: #0b7dda;}
...
$listetud=mysqli_query($conn,$etud);
?>
 ...
 <table class="table table-striped" style="text-align: center;">
      <tbody>
        <?php while ($row3 = mysqli_fetch_array($listetud)):
          $r=$row3[0];
          $rel="SELECT * FROM atstage where id_et=$r";
          $listrel=mysqli_query($conn,$rel);
          if (mysqli_fetch_array($listrel)) {

          ?>
          <tr>
              <td style="width: 70%;"><?php echo $row3[2]; ?> <?php echo $row3[1]; ?></td>
              <td><button class="btn-pret" data-toggle="modal" data-target="#tambah">Envoyé ☑</button></td>
          </tr>
          <?php  }else {
             ?>

          <tr>
              <td style="width: 70%;"><?php echo $row3[1]; ?> <?php echo $row3[1]; ?></td>
              <td>
                <form method="get" action="ajatstage.php">
<input type="text" name="id_et" value="<?php echo $row3[0]; ?>" hidden>

                <button class="buttonload" type="submit">
  Envoyer ✘ <i class="fa fa-spinner fa-spin"></i>
</button>
</form>
</td>
          </tr>
