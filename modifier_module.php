...
$module="SELECT * FROM module ORDER BY id_mod DESC";
...
<h3>Modifier/Supprimer Des Modules</h3>
</div>
      ...
      <tbody>
        <?php while ($row3 = mysqli_fetch_array($listmodule)):?>
          <tr>
              ...
              <td>
                <a href="modifmodule.php?id_mod=<?php echo $row3[0];?>">
                <img src="images/modif.png" style="width: 12%; height: 6%;"></a>
                <a href="#" data-toggle="modal" data-target="#exampleModal">
                <img src="images/sup.png" style="width: 12%; height: 6%;"></a>
              </td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="supprimer_module.php?id_mod=<?php echo $row3[0];?>"> <button type="button" class="btn btn-danger">Supprimer</button></a>
                        </div>
                    </div>
                </div>
            </div>
