...
<center>
  <form action="admodnote.php" method="get">
<table width="65%" style="text-align: center;">
  ...
  $i=0;
    ...
    <td style="border: 1px solid black;">
      ...
      <input type="text" name="etudiant<?php echo $i; ?>" hidden value="<?php echo $row1[0] ?>"><?php echo $row9[1]; ?></td>
    <td style="border: 1px solid black;"><?php echo $row9[2]; ?></td>
    <td style="border: 1px solid black;"><?php echo $row9[3]; ?></td>
  </tr>
<?php
}
}
