...
$servername="localhost";
  ...
  $matiereid=$_GET['id_mat'];


$mat="SELECT * FROM matiere where id_mat=$matiereid ";
$listmat=mysqli_query($conn,$mat);
...
<h3>Modifier Des Matiéres</h3>
</div>
<center>
    <div class="wrapper" >
         <div class="container">
             <h1>Modifier Une Matiére</h1>
             <form action="modmatiere.php" method="get">
               <fieldset>
                 
                 <div class="form-group" style="color: black;">
                   <label for="selection">Choisir Le Module <span style="color: red;">*</span></label>
                   <select id="selection" class="custom-select" name="module">
                       <?php while ($row5 = mysqli_fetch_array($listmodule)):?>
                       <option value="<?php echo $row5[0]; ?>" style="color: black;"><?php echo $row5[3]; ?></option>
                       <?php endwhile; ?>
                   </select>
                 </div>
                 <?php $row10 = mysqli_fetch_array($listmat)?>


                 <div class="form-group" style="color: black;">
                   <label for="email">Entrez Le Coefficient Du Matiére <span style="color: red;">*</span></label>
                   <input type="text" class="form-control" name="coefficient_mat" value="<?php echo $row10[1]; ?>" >
                 </div>


                 <div class="form-group" style="color: black;">
                   <label for="email">Entrez Le Nom Du Matiére <span style="color: red;">*</span></label>
                   <input type="text" class="form-control" name="nom_mat" value="<?php echo $row10[2]; ?>">
                   <input type="text" class="form-control" name="id_mat" value="<?php echo $row10[0]; ?>" hidden>
                 </div>
               </fieldset>
