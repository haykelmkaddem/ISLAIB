...
<?php
  ...
  $conn=mysqli_connect($servername,$username,$password,$dbname);
        ...
        $query1 = "SELECT * FROM etudiant WHERE id_classe='$classe' ";
          ...
          $query3 = "SELECT * FROM matiere WHERE id_mod='$mod' ";
...
<center>
  <form action="ajnote.php" method="get">
<table width="65%" style="text-align: center;">
  ...
  $i=0;
    ...
    <td style="border: 1px solid black;">
      ...
      <input type="text" name="orale<?php echo $i; ?>" style="color: black;"></td>
    <td style="border: 1px solid black;"><input type="text" name="ds<?php echo $i; ?>" style="color: black;"></td>
    <td style="border: 1px solid black;"><input type="text" name="exam<?php echo $i; ?>" style="color: black;"></td>
  </tr>
<?php
}
?>
...
<input style="margin-top: 7px; border-radius: 20px; margin-right: -740px; background-color: #8eb852; border-color: #8eb852;" type="submit" value="Ajouer Les Notes" class="btn btn-success">
</form>
</center>
</body>
</html>