...
<div class="image-holder" style=" margin-bottom: 30px;">
...
<?php
  ...
  $conn=mysqli_connect($servername,$username,$password,$dbname);
        ...
        $query1 = "SELECT * FROM etudiant WHERE id_classe='$classe' ";
          ...
          $query3 = "SELECT * FROM matiere WHERE id_mat='$mat' ";
                ...
                //$req8="SELECT * FROM note WHERE (id_mat='$mat' AND id_et='$et')";
                $req8="SELECT * FROM etudiant WHERE id_classe=$classe";
                $res4 = mysqli_query($conn,$req8);
?>

<center>
  <form action="modnote.php" method="get">
<table width="65%" style="text-align: center;">
  <tr>
    <th></th>
    <th style="border: 1px solid black;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;Groupe: <?php echo $row2[1]; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matiére: <?php echo $row3[2]; ?></th>
  </tr>
  <tr>
  ...
  $i=0;
                ...
                {  
                  $rq="SELECT * from note where (id_et=$row1[0] AND id_mat='$mat')";
                ...
                if ($row9=="") {
                  ...
                  ?>
    <tr>
    <td style="border: 1px solid black; width: 150px;"><?php echo $row1[0];  ?></td>
    <td width="25%" style="border: 1px solid black;"><?php echo $row1[1]." "; echo $row1[2];  ?></td> 
    <td style="border: 1px solid black;">
      <input type="text" name="matiere" hidden value="<?php echo $mat ?>">
      <input type="text" name="classe" hidden value="<?php echo $classe ?>">
      <input type="text" name="etudiant<?php echo $i; ?>" hidden value="<?php echo $row1[0] ?>">
      <input type="text" name="orale<?php echo $i; ?>" value="<?php echo $row9[1]; ?>" style="color: black;"></td>
    <td style="border: 1px solid black;"><input type="text" name="ds<?php echo $i; ?>" value="<?php echo $row9[2]; ?>" style="color: black;"></td>
    <td style="border: 1px solid black;"><input type="text" name="exam<?php echo $i; ?>" value="<?php echo $row9[3]; ?>" style="color: black;"></td>
  </tr>
<?php
}
}
...
<input style="margin-top: 7px; border-radius: 20px; margin-right: -730px; background-color: #8eb852; border-color: #8eb852;" type="submit" value="Modifier Les Notes" class="btn btn-success">
</form>
</center>
</body>
</html>